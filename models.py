...
class NearEarthObject:
    ...
    def serialize(self):
        """Json serialization string of  this NearEarthObject"""
...
class CloseApproach:
    ...
    def __init__(self, designation, time, distance, velocity):
        ...
        :param designation: designation to link the close approach to its NEO
        :param time: UTC date and time at which the NEO passes closest to Earth
        :param distance: distance in astronomical units, of the NEO to Earth
        :param velocity: velocity, in km/s, of the NEO relative to Earth
        """
    ...
    def json_serialize(self):
        """Json serialization string of this CloseApproach"""
    ...
    def csv_serialize(self):
        """CSV serialization string of this CloseApproach """
        return {'datetime_utc': datetime_to_str(self.time), 'distance_au': self.distance,
